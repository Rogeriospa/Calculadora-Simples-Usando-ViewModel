...
class MainViewModel: ViewModel() {
    ...
    val calcVisor: MutableLiveData<CalcVisor> by lazy {
        MutableLiveData<CalcVisor>()
    }
    // Enviar a variável calcVisor
    ...
    // Adicione o cálculo a ser feito no visor.calc
